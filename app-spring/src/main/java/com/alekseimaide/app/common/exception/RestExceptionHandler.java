...
import com.alekseimaide.app.common.response.ApiErrorResponse;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handles MalformedRequestException.
     *
     * @param ex the MalformedRequestException
     * @return the ApiError object
     */
    @ExceptionHandler(MalformedRequestException.class)
    protected ResponseEntity<Object> handleMalformedRequestException(MalformedRequestException ex) {
        ApiErrorResponse apiError = new ApiErrorResponse(BAD_REQUEST);
        apiError.setMessage(ex.getMessage());
        return buildResponseEntity(apiError);
    }
    ...
    protected ResponseEntity<Object> handleDataIntegrityViolation(DataIntegrityViolationException ex,
        ...
        return buildResponseEntity(
                new ApiErrorResponse(HttpStatus.CONFLICT, "Please ensure username is unique.", ex.getCause()));
    }
